...
import { getExamplesByTopicRequest } from "../../../services/examples.service";
...
function ExamplesByTopicPage() {
    ...
    const fetchExamples = async(page?: number) => {
        try {
            ...
            const result = await getExamplesByTopicRequest(currentTopic.id, page)
            if(!result) {
                setNoData(true);
                return
            }
...
export default ExamplesByTopicPage;